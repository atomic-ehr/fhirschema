...
const PACKAGES: Pkg[] = [
  ...
  { id: 'hl7.fhir.us.core', version: '8.0.0',
    url: 'https://packages.simplifier.net/hl7.fhir.us.core/8.0.0' },
  { id: 'hl7.fhir.us.core', version: '8.0.0-ballot',
    url: 'https://packages.simplifier.net/hl7.fhir.us.core/8.0.0-ballot' },
  { id: 'hl7.fhir.uv.sdc', version: '4.0.0-ballot',
    url: 'https://packages.simplifier.net/hl7.fhir.uv.sdc/4.0.0-ballot' },
  { id: 'basisprofil.de', version: '0.2.40',
    url: 'https://packages.simplifier.net/basisprofil.de/0.2.40' },
  { id: 'de.basisprofil.r4', version: '0.9.13',
    url: 'https://packages.simplifier.net/de.basisprofil.r4/0.9.13' },
  { id: 'de.basisprofil.r4', version: '1.0.0',
    url: 'https://packages.simplifier.net/de.basisprofil.r4/1.0.0' },
  { id: 'de.gevko.emdaf', version: '1.2.0',
    url: 'https://packages.simplifier.net/de.gevko.emdaf/1.2.0' },
  { id: 'de.medizininformatikinitiative.kerndatensatz.diagnose', version: '1.0.4',
    url: 'https://packages.simplifier.net/de.medizininformatikinitiative.kerndatensatz.diagnose/1.0.4' },
  { id: 'de.medizininformatikinitiative.kerndatensatz.medikation', version: '2.0.0-ballot1',
    url: 'https://packages.simplifier.net/de.medizininformatikinitiative.kerndatensatz.medikation/2.0.0-ballot1' },
  { id: 'kbv.basis', version: '1.2.0',
    url: 'https://packages.simplifier.net/kbv.basis/1.2.0' },
  { id: 'kbv.mio.diga', version: '1.0.0-festlegung',
    url: 'https://packages.simplifier.net/kbv.mio.diga/1.0.0-festlegung' },
  { id: 'colonoscopyreport.no', version: '0.7.4',
    url: 'https://packages.simplifier.net/colonoscopyreport.no/0.7.4' },
  { id: 'mimic', version: '0.1.2',
    localTgz: '../fhir-test-cases/validator/mimic/mimic-0.1.2.tgz' },
];
